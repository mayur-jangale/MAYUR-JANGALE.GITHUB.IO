<!DOCTYPE html>
<html>
<title>QUESTION | Classbroom.me Free Tests</title> 
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
   ...
   <div class="w3-bar-block w3-margin-bottom" style="margin:10px">
        <div class=" w3-white" style="margin:10px">
            <?php foreach($results as $row) {?>
<form action="/test/ans/<?php echo $type ?>" style="margin-left:20px; margit-top:-20px;margin-bottom:20px;" method="post">
<h2>Q<?php echo $qno ?>) <?php echo $row->que ?></h2>
  <input type="radio" name="ans" value="a"> <?php echo $row->a ?><br>
  <input type="radio" name="ans" value="b"> <?php echo $row->b ?><br>
  <input type="radio" name="ans" value="c"> <?php echo $row->c ?><br>  
    <input type="radio" name="ans" value="d"> <?php echo $row->d ?><br> 
     <input type="hidden" name="qno" value="<?php echo $qno ?>"> 
     <input type="hidden" name="id" value="<?php echo $row->id ?>"> 
     <input type="hidden" name="correct" value="<?php echo $correct ?>"> 
  <input type="submit" value="Check" style="margin-bottom:10px" class="w3-button w3-teal w3-padding-large w3-hover-black">
