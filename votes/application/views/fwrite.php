...
?><?php $this->view('head'); ?>
  ...
  echo '<button class="w3-btn w3-ripple w3-red w3-border w3-border-red  w3-round-large center"><a href="/people/vote/'.$row->user_id.'">Vote >></a></button>   '
          . '   <a href="https://api.whatsapp.com/send?text=MITACSC STUDENTS CORNER: VOTE FOR '.$row->user_fullname.', CLICK HERE https://studcorner.000webhostapp.com/people/vote/'.$row->user_id.'"><img src="/assets/whats.png" height="40px"></a>
  <hr />';
  
   

      }
  ?> <a href="/people/findfriends">
